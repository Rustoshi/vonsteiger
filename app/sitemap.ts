...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://www.vonsteiger.law";
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/agreement`, lastModified: new Date(), changeFrequency: "yearly", priority: 0.4 },
  ];
}
